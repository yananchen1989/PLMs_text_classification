...
class DataTrainingArguments:
    ...
    train_file: Optional[str] = field(
        default='df_finetune_train.csv', metadata={"help": "The input training data file (a text file)."})
    validation_file: Optional[str] = field(
        default='df_finetune_test.csv',
...
if data_args.dataset_name is not None:
    ...
    logger.info("load dataset from local==>{} {}".format(data_args.train_file, data_args.validation_file) )
    data_files = {}
...
if data_args.line_by_line:
    ...
    def tokenize_function(examples):
        ...
        examples["text"] = [line for line in examples["text"] \
              if len(line) > 10 and len(line.split(' '))>=5 \
                        and not line.isspace() and line.replace('\n','')!='' ]
        return tokenizer(
            examples["text"],
            padding=padding,
            truncation=True,
