...
def load_tabular_data(data_name, dict_no, noise_rate):
  ...
  if data_name == 'adult':
    ...
    data_train = pd.read_csv("dvrl_adult_data_train.csv")
    data_test = pd.read_csv("dvrl_adult_data_test.csv")
  ...
  train.to_csv('./data_files/train_{}.csv'.format(data_name), index=False)
  valid.to_csv('./data_files/valid_{}.csv'.format(data_name), index=False)
  test.to_csv('./data_files/test_{}.csv'.format(data_name), index=False)
